...
Инструкция для **экспериментальной** сборки Deck на Linux.  
Готовый архив для Ubuntu 22.04+ публикуется на [GitHub Pages](https://denispopkov.github.io/Deck/downloads/Deck-Linux-latest.tar.gz); ниже — как собрать из исходников.
